...
class St(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.will = bt.talib.WILLR(self.data.high, self.data.low, self.data.close, timeperiod=14)
...
quantstats.reports.html(returns, output='SMA/{}/Stats_3.html'.format(date_mode), title='BTC Sentiment')
